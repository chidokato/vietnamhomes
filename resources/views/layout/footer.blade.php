        ...
        <div class="row">
            ...
            <div class="col-md-8 ft-main">
                ...
                <div class="row ft-register-subscribe mb-4">
                    <div class="col-lg-6 align-self-center"><span class="line-b">ĐĂNG KÝ NHẬN THÔNG TIN TỪ <b>VIETNAM HOMES</b></span></div>
                    <div class="col-lg-6">
                ...
                <p class="ft-copyright text-end">Copyright © 2024 VIETNAM HOMES, All Rights Reserved</p>
            </div>
        </div>
    </div>
</footer>
